...
import com.example.myreceipeapp.viewModel.CategoryViewModel

@Composable
fun CategoryListScreen( modifier: Modifier = Modifier, navigateToDetailScreen: (Category) -> Unit){
    ...
    Box(modifier = Modifier.fillMaxSize()){
        when{
            ...
            viewState.error != "" ->{
                ...
                CategoryScreen(categories = viewState.categories, navigateToDetailScreen = navigateToDetailScreen)
            }
        }
    }
}
